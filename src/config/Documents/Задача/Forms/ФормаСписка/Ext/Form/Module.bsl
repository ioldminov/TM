...
Процедура ПриОткрытии(Отказ)
	...
	ПодключитьОбработчикОжидания("НачатьПроверкуНаличияНовыхНовостей", 20);
...
Функция НачатьПроверкуНаличияНовыхНовостейНаСервере(мАдресВХранилище, мАдресХранилищаНовостей)

    мПараметры = Новый Массив;
    мПараметры.Добавить(мАдресВХранилище);
    мПараметры.Добавить(мАдресХранилищаНовостей);
    ...
    Задание = ФоновыеЗадания.Выполнить("фзФоновыеЗадания.ПроверитьНаличиеНовыхНовостей", 
        мПараметры, мУникальныйИдентификатор, "Пример асинхронной концепции программирования");    
...
Процедура НачатьПроверкуНаличияНовыхНовостей()
	...
	УИДФЗПроверкаНовостей = НачатьПроверкуНаличияНовыхНовостейНаСервере(АдресДанныхВХранилище, АдресХранилищаНовостей);
	ОтключитьОбработчикОжидания("ОповеститьПользователя");
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//АдресХранилищаНовостей = ПолучитьАдресХранилищаНовостейНаСервере();
	АдресХранилищаНовостей = ПоместитьВоВременноеХранилище(Неопределено, ЭтаФорма.УникальныйИдентификатор);
	АдресДанныхВХранилище = ПоместитьВоВременноеХранилище(Неопределено, ЭтаФорма.УникальныйИдентификатор);
