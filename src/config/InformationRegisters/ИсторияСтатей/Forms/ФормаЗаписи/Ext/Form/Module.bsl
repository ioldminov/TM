...
Процедура ВставитьГиперссылку(Команда)
	...
	ИмяОткрываемойФормы = "РегистрСведений.ИсторияСтатей.Форма.ВыборГиперссылки";
...
Процедура ВыборЦвета(Команда)
	...
	Цвет = ПолучитьФорму("РегистрСведений.ИсторияСтатей.Форма.ВыборЦвета").ОткрытьМодально();
